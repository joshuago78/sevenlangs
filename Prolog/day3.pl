% Make Sudoku 9x9 puzzle



print_row([]) :-
	write('||'), nl.
print_row([CelA, CelB, CelC|Tail]) :-
	print('|| '),
	print(CelA),
	print(' | '),
	print(CelB),
...
print_three_rows([RowA, RowB, RowC]) :-
	print_row(RowA),
	print('-----------------------------------------'), nl,
	print_row(RowB),
	print('-----------------------------------------'), nl,
...
print_rows([]) :- !.
print_rows([RowA, RowB, RowC|Tail]) :-
	print_three_rows([RowA, RowB, RowC]),
	print_rows(Tail).


print_board(Solution) :-
	nl, print('-------------Sudoku Solution-------------'), nl,
	print('========================================='), nl,
	print_rows(Solution).
...
% one line form
% [-, -, -, 8, 3, -, -, -, -, -, -, 3, -, -, -, -, 7, -, 6, 9, 5, 2, 7, 4, -, -, -, 9, -, 1, -, 6, -, -, 5, 8, -, 2, -, -, -, -, -, 1, -, 3, 6, -, -, 5, -, 4, -, 2, -, -, -, 4, 1, 5, 7, 2, 6, -, 1, -, -, -, -, 5, -, -, -, -, -, -, 8, 9, -, -, -]
